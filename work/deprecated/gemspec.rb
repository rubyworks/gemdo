module POM
  class Project
    ##
    # Mixin adds methods for accessing a project's gemspec and
    # other gem releated features.
    #
    module GemUtils
    ...
    public
      ...
      # TODO: Replace everything below here with Indexer code and tie into above.
