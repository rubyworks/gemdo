...
Load metadata from fixture.
  ...
  metadata = POM::Metadata.load('fixture')

Verify contact metadata is being read from directory location.

  metadata.contact.assert == "trans <transfire@gmail.com>"

Verify version metadata is being read from directory location.

  metadata.version.assert == "1.0.0"

Verify description metadata is being read from directory location.
