...
* home: http://proutils.github.com/gemdo
* code: http://github.com/protuils/gemdo


== DESCRIPTION

Gemdo defines a standard Ruby Project Object Model (POM), encompassing a 
...
See the Wiki[http://wiki.github.com/proutils/gemdo] and
API[http://proutils.github.com/gemdo/rdoc] documentation for further
details.


== Upgrading from POM

Earlier versions of Gemdo were called "POM" and used a directory-based
...
lack of familiarity to developers. The latest versions of Gemdo therefore
...
the gemdo command provides a helpful subcommand:
